...
<div class="container-fluid">
        ...
        <div class="card border-left-success shadow h-100 py-2">
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">parkings</div>
                <div class="h5 mb-0 font-weight-bold text-gray-800">{{\App\Models\parking::countActiveparking()}}</div>
              </div>
              <div class="col-auto">
    ...
    <div class="row">
      @php
          $bookings=DB::table('bookings')->where('user_id',auth()->user()->id)->paginate(10);
      @endphp
      <!-- Booking -->
        ...
        <table class="table table-bordered" id="order-dataTable" width="100%" cellspacing="0">
          ...
          <tbody>
            @if(count($bookings)>0)
              ...
              @endforeach
              @else
                <td colspan="8" class="text-center"><h4 class="my-4">You have not booked any parking!</h4></td>
              @endif
          </tbody>
        </table>
...
<script type="text/javascript">
  const url = "{{route('parking.order.income')}}";
