...
@section('main-content')s
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Booking History</h6>
    </div>
    <div class="card-body">
      <div class="table-responsive">
        ...
        @else
          <h6 class="text-center">No Parking Booked Yet!</h6>
        @endif
      </div>
    </div>
</div>
